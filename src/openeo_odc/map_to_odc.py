        ...
        if cur_node.parent_process: #parent process can be eiter reduce_dimension or apply
            if parent_proc_id == 'reduce_dimension':
                ...
                if 'context' in cur_node.parent_process.content['arguments']:
                    if 'model' in cur_node.parent_process.content['arguments']['context']:
                        kwargs['model'] = cur_node.parent_process.content['arguments']['context']['model']
                    if 'predictors_vars' in cur_node.parent_process.content['arguments']['context']:
                        kwargs['predictors_vars'] = cur_node.parent_process.content['arguments']['context']['predictors_vars']
