...
_kryhimf6r_6 = oeop.array_element(**{'data': [1, 1, 1], 'index': 0})
_jxs4umqsh_10 = oeop.array_element(**{'data': [1, 1, 1], 'index': 1})
_8jjjztmya_12 = oeop.array_element(**{'data': [1, 1, 1], 'index': 2})
