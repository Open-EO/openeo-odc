...
_wz26aglyi_5 = oeop.multiply(**{'x': _p42lrxmbq_16, 'y': _p42lrxmbq_16})
_kryhimf6r_6 = oeop.array_element(**{'data': _parameters, 'index': 0})
_jxs4umqsh_10 = oeop.array_element(**{'data': _parameters, 'index': 1})
_8jjjztmya_12 = oeop.array_element(**{'data': _parameters, 'index': 2})
_ya3hbxpot_17 = oeop.multiply(**{'x': _1ipvki94n_4, 'y': _1ipvki94n_4})
...
_18_0 = oeop.fit_curve(**{'data': _b4mf181yp_3, 'function': _b4mf181yp_3, 'parameters': [1, 1, 1], 'dimension': 't', 'reducer': {}})
